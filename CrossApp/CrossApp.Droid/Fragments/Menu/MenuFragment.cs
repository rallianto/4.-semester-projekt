...
using CrossApp.Droid.Activities;
...
namespace CrossApp.Droid.Fragments
{
    ...
    [Register("crossapp.droid.fragments.MenuFragment")]
    public class MenuFragment : MvxFragment<MenuViewModel>, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        private async Task Navigate(int itemId)
        {
            ...
            switch (itemId)
            {
                ...
                break;
                case Resource.Id.nav_create_project:
                ViewModel.ShowCreateProjectCommand.Execute();
                break;
                case Resource.Id.nav_bid_project:
                ViewModel.ShowFindProjectCommand.Execute();
                break;
                case Resource.Id.nav_login:
                ViewModel.ShowUserLogin.Execute();
                break;
